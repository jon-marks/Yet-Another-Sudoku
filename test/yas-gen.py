    ...
    for i in range(1, len(argv)):
        if argv[i][:2] in ["i=", "I="]:
            ...
            print(f"Syntax: yas-sol.py [i=<input file path>] [o=<output file path>] [s=<n>] [e=<m>]\n"
                  ...
                  f"             If “s” is also specified puzzles will be generated by randomly digging holes\n"
                  f"             in the same supplied solution, generating minimal puzzles  If “p” is specified\n"
                  f"             then that supplied puzzle will be randomized n times.\n"
                  f"             Either 's' or 'p' can specify a puzzle.  If neither do then the puzzles found as\n"
                  f"             specified by the 'i' switch are used.  If both 's' and 'p' specify puzzles then that\n"
                  f"             from the later specified switch is taken.\n"
                  f"  s=<Pzl Spec>:  Only the grid is considered in the puzzle spec string, Givens are not preserved.\n"
                  f"             Upto n puzzles will be generated as specified in the 'n' switch.\n"
                  ...
                  f"             for x, they can be post fixed with a digit 0..8, where:\n"
                  ...
                  f"  d=<path>:  (optional) database file to create or append (if exists), if <path> not specified,\n"
                  f"             default: {Db}\n"
