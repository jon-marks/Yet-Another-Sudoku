...
from structs_x cimport soln_t

#from solve_utils_x cimport *  #cell_val_has_no_conflicts
#from solve_utils_x import *  #cell_val_has_no_conflicts

from generate_x cimport *
from solve_utils_x cimport *
# cimport generate_x
# cimport solve_utils_x

# from generate_x cimport *  # needs to cimport all its header definitions
#
# cimport solve_utils_x
# from solve_utils_x cimport cell_value_has_no_conflicts_c
#
# from solve_utils_x import cell_value_has_no_conflicts
