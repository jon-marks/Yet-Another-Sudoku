...
In my journey of understanding Sudoku logic which is documented here, Following is a list of website links read and watched.  Additionally, the text is peppered with specific web page links where the specific reference is applied.
