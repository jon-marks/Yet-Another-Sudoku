.. title:: Yet Another Sudoku | References
...
My appreciation of Sudoku logic is documented here, Following is a list of website links read and watched.  Additionally, the text is peppered with specific web page links where the specific reference is applied.
...
http://forum.enjoysudoku.com/unique-rectangles-the-essentials-t4204.html
