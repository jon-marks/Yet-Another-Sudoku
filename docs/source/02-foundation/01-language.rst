...
Agreement on a comprehensive language to communicate Sudoku concepts, avoids a
`Confusion of Tongues <https://en.wikipedia.org/wiki/Tower_of_Babel#Confusion_of_tongues>`_.  This is my attempt to draw from what I consider best
