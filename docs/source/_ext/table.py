# Stolen from cloud_sptheme.ext.table_styling, and brutalised by me.
...
# constants
EMBED_KEY = "table_styling_embed_css"  # name of key controlling whether css file is included
CLASS_KEY = "table_styling_class"  # name of key controlling css class name
TABLE_DEFAULT_ALIGN_KEY = "table_styling_default_align"  # name of key controlling css class name
