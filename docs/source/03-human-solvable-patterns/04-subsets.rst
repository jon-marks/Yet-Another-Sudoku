...
These patterns are a special case of :ref:`Nearly Locked Sets <found_nls>`, where two
...
These patterns are another special case of :ref:`Nearly Locked Sets <found_nls>`.  A Hidden
...
:ref:`Nearly Locked Sets <found_nls>`.  See the above sources for that discussion, our interest
