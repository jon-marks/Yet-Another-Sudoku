#!/usr/bin/env python
# Adaptation of setup.py to follow YAS's directory environment: Appendix A
# in the Sudoku.odt, and the changes to get mingw64 gcc to work in appendix C

# TODO:  Fix ofr latest version of setup tools.
